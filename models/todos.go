...
type Todo struct {
	...
	User      string    `form:"user" boil:"user" json:"user" toml:"user" yaml:"user"`
...
var TodoWhere = struct {
	...
	User:      whereHelperstring{field: "`todos`.`user`"},
	...
	UpdatedAt: whereHelpernull_Time{field: "`todos`.`updated_at`"},
}
...
var (
	todoAllColumns            = []string{"id", "user", "content", "status", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"id", "user", "content", "status", "created_at", "updated_at"}
